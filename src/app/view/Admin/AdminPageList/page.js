...
import ControllerIcon from '@/app/modal/controllerIcon/page';
import IconModal from '@/app/modal/iconModal/page';
...
console.log(addValue)
            ...
            fetch('http://localhost:5002/admin/allAdmin', {
                method: 'POST',
                headers: {
                                                    ...
                                                    <tbody className="files">
                                                        <tr>
                                                            <td>
                                                                ...
                                                                {/* {error && index === inputValues.length - 1 && (
                                                            ...
                                                            <td>
                                                                {/* <input
                                                                   onChange={(event) => handleInputChange(index, event)}
                                                                    ...
                                                                    name="controller_bg"
                                                                    data-input={`controller_bg[${index}]`}
                                                                    className="form-control form-control-sm  controller_bg"
                                                                    placeholder="Enter Controller Background"
                                                                    defaultValue={inputValue.controller_bg}
                                                                />  */}
                                                                <input
                                                                    onChange={(event) => handleInputChange(index, event)}
                                                                    type="color"
                                                            ...
                                                            <td>
                                                                ...
                                                                {/* <input
                                                                   onChange={(event) => handleInputChange(index, event)}
                                                                    type="color"
                                                                    name="controller_color"
                                                                    data-input={`controller_color[${index}]`}
                                                                    className="form-control form-control-sm  row_unique_controller_name"
                                                                    placeholder="Enter Controller Color"
                                                                    defaultValue={inputValue.controller_color}
                                                                /> */}
                                                            ...
                                                            <td>
                                                                <div className="input-group">
                                                                    ...
                                                                    {/* <input
                                                                        type="text"
                                                                        className="form-control form-control-sm icon"
                                                                        name="icon"
                                                                        placeholder="Enter Controller Icon"
                                                                    ...
                                                                    <div className="input-group-append">
                                                                        <button
                                                                            ...
                                                                            type="button"
                                                                            onClick={() => handleInputChange(index, { target: { name: 'icon', value: '' } })}
                                                                        >
                                                                            <HiTrash />
                                                                        </button>
                                                                        <button
                                                            ...
                                                            <td>
                                                                <div className="input-group">
                                                                    {/* <input
                                                                        ...
                                                                        defaultValue={inputValue.page_group_icon}
                                                                        onChange={(event) => handleInputChange(index, event)}
                                                                    />
                                                                    <div className="input-group-append">
                                                                        <button
                                                                            ...
                                                                            data-input={`page_group_icon[${index}]`}
                                                                            type="button"
                                                                            onClick={() => handleInputChange(index, { target: { name: 'page_group_icon', value: '' } })}
                                                                        >
